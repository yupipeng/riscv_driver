...
#define   RC522_Reset_Enable()      hal_gpio_output_level_set(GPIO0_30_INDEX, GPIO_LOW)
#define   RC522_Reset_Disable()     hal_gpio_output_level_set(GPIO0_30_INDEX, GPIO_HIGH)
